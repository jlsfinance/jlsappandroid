                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-2xl border border-blue-100 dark:border-blue-800">
                            <p className="text-xs text-blue-600 dark:text-blue-300 font-bold uppercase">Total Disbursed</p>
                            <p className="text-2xl font-bold text-blue-900 dark:text-white">{formatCurrency(summaryData.totalLent)}</p>
                        </div>
        ...
        case 'lent':
            return (
                <div className="space-y-4 animate-in fade-in">
                    ...
                    <div className="bg-white dark:bg-[#1e2736] rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
                        <table className="w-full text-sm text-left">
                            <thead className="bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-300">
                                <tr>
                                    <th className="px-4 py-2">Date</th>
                                    <th className="px-4 py-2">Customer</th>
                                    <th className="px-4 py-2 text-right">Amount</th>
